...
<html lang="en">
  ...
  <body class="light">
    ...
    <!-- #Top Bar -->
    <div>
      <?php include './pages/authorized/employee/include/navigation-bar.php';   ?>
    </div>
      ...
      <div class="container-fluid">
            ...
            <div class="card l-bg-purple">
              <div class="info-box-5 p-4">
                ...
                <div class="row align-items-center mb-2 d-flex">
                  <div class="col-8">
                    <h2 class="d-flex align-items-center mb-0">280</h2>
                  </div>
                  <div class="col-4 text-end">
                    <span class="fw-bold"
                      >100% <i class="fa fa-arrow-up"></i
                    ></span>
                  </div>
                </div>
          ...
          <div class="col-xl-3 col-lg-6">
            <div class="card l-bg-blue-dark">
              <div class="info-box-5 p-4">
                ...
                <div class="row align-items-center mb-2 d-flex">
                  <div class="col-8">
                    <h2 class="d-flex align-items-center mb-0">113</h2>
                  </div>
                  <div class="col-4 text-end">
          ...
          <div class="col-xl-3 col-lg-6">
            <div class="card l-bg-green-dark">
              <div class="info-box-5 p-4">
                ...
                <div class="row align-items-center mb-2 d-flex">
                  <div class="col-8">
                    <h2 class="d-flex align-items-center mb-0">102</h2>
                  </div>
                  <div class="col-4 text-end">
          ...
          <div class="col-xl-3 col-lg-6">
            <div class="card l-bg-orange-dark">
              <div class="info-box-5 p-4">
                ...
                <div class="row align-items-center mb-2 d-flex">
                  <div class="col-8">
                    <h2 class="d-flex align-items-center mb-0">$2,658</h2>
                  </div>
                  <div class="col-4 text-end">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              <div class="header">
                <h2><strong>Products</strong> Chart</h2>
              </div>
              <div class="body">
          ...
          <div class="col-lg-6">
            <div class="card">
              <div class="header">
                <h2><strong>Profit</strong> Chart</h2>
              </div>
              <div class="body">
                <div class="recent-report__chart">
                  <div id="chart2"></div>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          >
                            <div
                              class="
                                progress-bar progress-bar-lightred
                                width-per-60
                              "
                              role="progressbar"
                              aria-valuenow="60"
          ...
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
            <div class="card">
              ...
              <div class="body">
                ...
                <input
                  type="text"
                  class="tdl-new form-control-radious"
