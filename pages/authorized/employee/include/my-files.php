...
<html lang="en">
   ...
   <body class="light">
                        ...
                        <div class="button-demo">
                           <div class="row clearfix">
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="card">
                                    <div class="body">
                                       <form  id="my-files-form" class="dropzone p-4" method="post" enctype="multipart/form-data">
                                          <div class="d-block mb-4">
                                             <input name="title" placeholder="Enter file name" type="text">
                                          </div>
                                          <div class="d-block mb-4">
                                             <input class="file-path validate" name="requestFile" type="file">
                                          </div>
               ...
               <div class="container">
                  <div class="body table-responsive">
                     <table class="table">
                        ...
                        <tbody>
                           <?php for ($i=0, $fc = count(getUploadedMyFiles()); $i < $fc; $i++) {?>
                           <tr>
                              <th scope="row">1</th>
                              <td><?php echo getUploadedMyFiles()[$i]['title']; ?></td>
                              <td> <a href="<?php echo 'assets/upload-files/'.getUploadedMyFiles()[$i]['fileName']; ?>" target="_blank"><?php echo getUploadedMyFiles()[$i]['fileName']; ?></a> </td>
                              <td> <a href="#" 
                                 data-attr-id="<?php echo getUploadedMyFiles()[$i]['id']; ?>"
                                 data-filename="<?php echo getUploadedMyFiles()[$i]['fileName']; ?>"
                                  class="text-danger delete-my-files">Delete</a> </td>
                           </tr>
                           <?php } ?>
                        </tbody>
                     </table>
      ...
      <script src="assets/js/main/my-files.js"></script>
